...
$(document).ready(function() {
    ...
    $('.tender-list .favourite').on('click', function(e) {
      e.preventDefault();
    ...
    $('.tender-view-controller .controller, .candidate-view-controller .controller, .employer-view-controller .controller').on('click', function() {
      $('.tender-view-controller .controller, .candidate-view-controller .controller, .employer-view-controller .controller').removeClass('active');
      $(this).addClass('active');
    })

    $('.tender-view-controller .list, .candidate-view-controller .list, .employer-view-controller .list').on('click', function() {
      $('.tender-filter-result, .candidate-filter-result, .employer-filter-result').removeClass('grid');
      $('.tender-filter-result .tender-list, .candidate-filter-result .candidate, .employer-filter-result .employer').removeClass('half-grid');
    })
	
    $('.tender-view-controller .grid, .candidate-view-controller .grid, .employer-view-controller .grid').on('click', function() {
      $('.tender-filter-result, .candidate-filter-result, .employer-filter-result').addClass('grid');
      $('.tender-filter-result .tender-list, .candidate-filter-result .candidate, .employer-filter-result .employer').addClass('half-grid');
    });
    ...
    $('.tender-filter .option-title, .candidate-filter .option-title, .employer-filter .option-title').on('click', function (event) {
      var clickover = $(event.target);
      $(this).each(function() {
    ...
    $('.tender-filter a, .candidate-filter a, .employer-filter a').on('click', function(e) {
      e.preventDefault();
      var cls = $(this).parents(".tender-filter, .candidate-filter, .employer-filter").data("id");
    ...
    $(document).on('click', ".tender-filter li a, .candidate-filter li a, .employer-filter li a", function() {
    ...
    -------------------------------------------*/
     ...
     var listingContainer = '.listing-with-map .tender-listing-container';
     var windowWidth = $(window).innerWidth();
      ...
      $(document).on('click','.sidebar-switch', function() {
        ...
        if($(this).hasClass('on')){
          ...
          $('.tender-filter-wrapper').css({
            'display': 'block',
            'margin-left': 0,
            'width': '280px'
          });

          $('.filtered-tender-listing-wrapper').css({
            'width': '760px'
          });

          $('.tender-listing-container').css({
            'width': '1040px'
          });

          var listingContainerWidth = $('.listing-with-map .tender-listing-container').innerWidth();
          ...
          $('.filtered-tender-listing-wrapper').addClass('change-padding');
